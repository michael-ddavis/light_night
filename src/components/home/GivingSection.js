        ...
        <div className="relative pb-32">
          ...
          <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            ...
            <p className="mt-6 max-w-lg text-left text-xl text-gray-300">
              Looking for ways to give to what God is doing? <br />Click the give button below.
            </p>
            <Link to="/giving" className="transition duration-150 ease-linear bg-transparent border-2 border-green-500 rounded-md 
            shadow p-8 md:px-16 py-3 mt-8 inline-flex items-center font-medium tracking-widest textbase md:text-2xl text-white 
            hover:bg-green-500 hover:border-transparent hover:text-white">GIVE</Link>     
          </div>
        </div>
      </div>
     );
